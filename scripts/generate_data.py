...
with out.open("w", newline="") as f:
    w=csv.writer(f); w.writerow(["transaction_amount","merchant_category","country_risk_score","account_age_days","transaction_count_24h","failed_auth_attempts_24h","is_new_device","hour_utc","label_is_high_risk"])
    for _ in range(100):
