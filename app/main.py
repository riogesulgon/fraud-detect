...
def model_info() -> dict[str, Any]:
    ...
    return {"model_version": meta["model_version"], "training_timestamp": None, "metrics": metrics, "feature_schema_version": FEATURE_SCHEMA_VERSION, "dataset": meta["dataset"], "decision_threshold": meta.get("decision_threshold", THRESHOLD)}
